...
function Login1(props) {
    ...
    // className="bgi-no-repeat" style={{ backgroundColor: 'white', backgroundPosition: 'center center', backgroundSize: 'cover', backgroundImage: `url(${Bubbles})`, }}
    ...
    return (
        <>
            ...
            <div className="bg-night-owl">
                <div className="banner bgi-no-repeat">
                            ...
                            <div className="d-flex flex-center flex-row-fluid">
                                <div className="login-form text-center p-7">
                                    ...
                                    <div className="login-signin mw-40ch">
                                        <div className="mb-10">
                                            <h3 className="text-warning">Đăng nhập</h3>
                                            <div className="text-white font-weight-bold">Amateur Shipper for Merchants</div>
                                        </div>
                                        ...
                                        <div className="mt-10">
                                            <span className="text-warning mr-4">Bạn chưa có tài khoản?</span>
                                            <Link to="register" className="text-white font-weight-bold">
                                                Đăng ký!
                                            </Link>
                                        </div>
                                    </div>
